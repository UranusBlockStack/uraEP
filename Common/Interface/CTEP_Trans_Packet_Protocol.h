...
#define CTEP_DEFAULT_BUFFER_SIZE		(4096-80)		// I/O请求的缓冲区大小, 表示一次IO包的最大允许长. RDP通道在较大大小时会丢失数据
#define CTEP_DEFAULT_BUFFER_DATA_SIZE	(CTEP_DEFAULT_BUFFER_SIZE - sizeof(CTEPPacket_Message))	// 一次CTEPPacket_Message包里最大可以包含的数据长度
